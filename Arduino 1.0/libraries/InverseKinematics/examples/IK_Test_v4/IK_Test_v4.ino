...
//Arm positioning routine utilizing inverse kinematics
  void setArm( float x, float y, float z, float grip_angle_d )  //Z is height, y is distance horizontally from base, x is side to side (i.e. turning). y,z can only be positive
  {
    //Calculate servo pulses (i.e. direction or angle) for coordinates
      setArmCalc( float x, float y, float z, float grip_angle_d);
